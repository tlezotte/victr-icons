...
## Latest Version: **v0.6.5** - 1 images
...
```html
<!-- victr: Icon Font -->
<link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/tlezotte/victr-icons@<version>/style.min.css">
```

```html
<!-- victr: SVG Sprite -->
<link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/tlezotte/victr-icons@<version>/sprite/sprite.min.css">
```
...
CDN Details: [jsdelivr](https://www.jsdelivr.com/package/gh/tlezotte/victr-icons)
